...
#include "Field_Grassland_c_version.h"

// Sets default values
AField_Grassland_c_version::AField_Grassland_c_version()
{
...
void AField_Grassland_c_version::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AField_Grassland_c_version::Tick(float DeltaTime)
{
